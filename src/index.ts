...
import { createTables, openDatabase } from './database/queries';
import { setDatabaseIpcHandlers } from './databaseApi';
...
const tempDatabaseFilepath = join(homedir(), 'Downloads', 'tempDatabase.sqlite3');
